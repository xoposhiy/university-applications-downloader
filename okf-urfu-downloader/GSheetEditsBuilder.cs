...
namespace lib.db
{
    public class GSheetEditsBuilder
    {
        ...
        public GSheetEditsBuilder WriteRange(ValueTuple<int, int> leftTop, List<List<string>> payload)
        {
        ...
        public GSheetEditsBuilder MergeCell(ValueTuple<int, int> rangeStart, ValueTuple<int, int> rangeEnd)
        {
